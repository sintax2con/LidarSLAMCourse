...
void PLICPMatcher::SetPIICPParams()
{
    //设置激光的范围
...
void PLICPMatcher::LaserScanToLDP(const champion_nav_msgs::ChampionNavLaserScanConstPtr &pScan, LDP &ldp)
{
...
Eigen::Vector3d PLICPMatcher::PIICPBetweenTwoFrames(LDP &currentLDPScan, Eigen::Vector3d tmprPose)
{
